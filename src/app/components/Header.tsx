    ...
    >
      <div className="container mx-auto px-10 py-4">
        <nav>
          ...
          <ul id="sidemenu">
            <li><a href="#header" className="text-white hover:text-red-500">Home</a></li>
            ...
            <li><a href="#portfolio" className="text-white hover:text-red-500">Portfolio</a></li>
        ...
        <div className="header-text">
          ...
          <h3 className="mt-2 text-2xl md:text-3xl">And I'm a <span className="typing text-red-500"></span></h3>
        </div>
      </div>
    </div>
  )
